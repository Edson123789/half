...
import 'package:e_shop/generated_plugin_registrant.dart';
...
class _RegisterState extends State<Register>
{
  ...
  Widget build(BuildContext context) {
    double _screenWidth = MediaQuery.of(context).size.width, screenHeight = MediaQuery.of(context).size.height;
